...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GATE_1_OUT_Pin|GATE_2_OUT_Pin|GATE_3_OUT_Pin|GATE_3_OUTB15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GATE_1_OUT_Pin GATE_2_OUT_Pin GATE_3_OUT_Pin GATE_3_OUTB15_Pin */
  GPIO_InitStruct.Pin = GATE_1_OUT_Pin|GATE_2_OUT_Pin|GATE_3_OUT_Pin|GATE_3_OUTB15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
