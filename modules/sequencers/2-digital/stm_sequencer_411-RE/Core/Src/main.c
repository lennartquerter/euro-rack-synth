...
int main(void)
{
    ...
    mcp4822_init(&dac_config, SPI1_CS_GPIO_Port, SPI1_CS_Pin, &hspi1);
...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOC, GATE_A_OUT_Pin | GATE_B_OUT_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : GATE_A_OUT_Pin GATE_B_OUT_Pin */
    GPIO_InitStruct.Pin = GATE_A_OUT_Pin | GATE_B_OUT_Pin;
    ...
    /*Configure GPIO pins : TIM3_BTN_Pin CLK_IN_Pin */
    GPIO_InitStruct.Pin = TIM3_BTN_Pin | CLK_IN_Pin;
    ...
    /*Configure GPIO pin : TIM4_BTN_Pin */
    GPIO_InitStruct.Pin = TIM4_BTN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TIM4_BTN_GPIO_Port, &GPIO_InitStruct);
