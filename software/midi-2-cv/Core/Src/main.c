...
/* USER CODE END MX_GPIO_Init_1 */
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(MIDI_CLOCK_OUT_GPIO_Port, MIDI_CLOCK_OUT_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, GATE_A_Pin | GATE_B_Pin | GATE_C_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : GATE_A_CONNECTED_Pin GATE_B_CONNECTED_Pin GATE_C_CONNECTED_Pin GATE_D_CONNECTED_Pin */
    GPIO_InitStruct.Pin = GATE_A_CONNECTED_Pin | GATE_B_CONNECTED_Pin | GATE_C_CONNECTED_Pin | GATE_D_CONNECTED_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    /*Configure GPIO pin : MIDI_CLOCK_OUT_Pin */
    GPIO_InitStruct.Pin = MIDI_CLOCK_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(MIDI_CLOCK_OUT_GPIO_Port, &GPIO_InitStruct);

    /*Configure GPIO pins : GATE_A_Pin GATE_B_Pin GATE_C_Pin */
    GPIO_InitStruct.Pin = GATE_A_Pin | GATE_B_Pin | GATE_C_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    /*Configure GPIO pin : GATE_D_Pin */
    GPIO_InitStruct.Pin = GATE_D_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GATE_D_GPIO_Port, &GPIO_InitStruct);
